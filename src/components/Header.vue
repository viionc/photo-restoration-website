...
<template>
    <header :class="`z-[100] w-full flex justify-center top-0 left-0 bg-white fixed border-b border-orange-500 shadow-lg bg-opacity-90`">
        <nav class="container flex gap-2 lg:gap-12 h-20 items-center px-2">
            ...
            <ul
                :class="`ms-0 md:ms-auto text-4xl md:text-2xl w-full md:w-auto top-0 flex h-[100dvh] md:h-full absolute  z-[1000] flex-col justify-center items-center transition-all duration-300 ease-in-out
